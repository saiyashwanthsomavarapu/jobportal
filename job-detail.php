...
.nav-crumb.active { color: var(--text-primary); font-weight: 600; }
...
.detail-icon svg { width: 13px; height: 13px; color: var(--accent); }

.detail-info { flex: 1; min-width: 0; }
.detail-label { font-size: 10.5px; font-weight: 700; letter-spacing: .07em; color: var(--text-muted); margin-bottom: 2px; }
.detail-value { font-size: 12px; font-weight: 500; color: var(--text-primary); line-height: 1.4; }
...
.salary-label { font-size: 10.5px; font-weight: 700; letter-spacing: .07em; color: var(--text-muted); text-transform: uppercase; margin-bottom: 2px; }
...
.similar-job-item:hover .sjob-title { color: var(--accent); }
...
.sjob-chip.wp-remote { color: #1a5fa8; background: #e6f0fb; border-color: #c8d9f0; }
.sjob-chip.wp-hybrid  { color: #7a4f00; background: #fdf3dc; border-color: #f0d9a0; }
.sjob-chip.wp-onsite  { color: #1a8a5a; background: #e6f7f1; border-color: #a8dfc8; }
...
@media (max-width: 820px) {
  ...
  .job-header { padding-left: 24px; padding-right: 24px; }
}
</style>
</head>
<body>
...
<div class="page">
  ...
  <div class="main-col">
    ...
    <div data-fillout-id="1sLDbgFUV2us" data-fillout-embed-type="popup" data-fillout-button-text="Apply Now !" data-fillout-dynamic-resize data-fillout-button-color="#1A4C8F" data-fillout-inherit-parameters data-fillout-popup-size="medium"></div><script src="https://server.fillout.com/embed/v1/"></script>
<?php } else { ?>
    <div
...
<?php } ?>
    ...
    <div class="sidebar-card" style="margin-top:5%;">
    ...
    <div class="sidebar-card" style="background:#245699;">
